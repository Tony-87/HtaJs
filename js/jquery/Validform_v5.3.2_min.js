    ...
    a.util = {
        dataType: {
            ...
            o.find("[datatype]").each(function () {
                if (l == 2) {
                    if (d(this).parent().find(".Validform_checktip").length == 0) {
            ...
            if (l == 2 && m.obj) {
                m.obj.parent().find(".Validform_checktip").html(n);
                a.util.cssctl(m.obj.parent().find(".Validform_checktip"), m.type)
            }
            if ((l == 3 || l == 4) && m.obj) {
